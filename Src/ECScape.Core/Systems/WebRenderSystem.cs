...
public sealed class WebRenderSystem : ISystem
{
    public readonly Entry[,] frontBuffer;
    public readonly Entry[,] backBuffer;

    public WebRenderSystem(int width, int height)
    {
    ...
    public readonly record struct Entry(char Symbol, ConsoleColor Color)
    {
